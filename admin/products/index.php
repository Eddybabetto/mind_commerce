      ...
      <?php foreach ($array_prodotti as $prodotto): ?>
        <tr>
          ...
          <td>
            ...
            <button class="button-reset">reset Prodotto</button>
          </td>
        </tr>
...
<script>
  ...
  Array.from(bottoni_edit).forEach(btn => {
    btn.addEventListener("click", (event) => {
      ...
      original_data[all_tds[0].innerText] = {
        ...
        name: all_tds[1].innerText,
      }

      let inputname = document.createElement("input")
      inputname.value = structuredClone(original_data[all_tds[0].innerText].name)

      all_tds[1].replaceChildren(inputname)
  ...
  Array.from(bottoni_reset).forEach(btn => {
    btn.addEventListener("click", (event) => {
      ...
      all_tds[1].innerText = original_data[all_tds[0].innerText].name
